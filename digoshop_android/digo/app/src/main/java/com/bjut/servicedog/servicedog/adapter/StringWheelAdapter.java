...
public class StringWheelAdapter extends BaseWheelAdapter<String> {
	public StringWheelAdapter(Context context, List<String> floors) {
		super(context,floors);
	}

	@Override
	protected CharSequence getItemText(int index) {
		String data = getItemData(index);
		if(data != null){
			return data;
		}
		return null;
