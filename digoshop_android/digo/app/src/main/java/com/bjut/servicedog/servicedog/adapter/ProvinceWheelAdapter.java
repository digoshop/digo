...
public class ProvinceWheelAdapter extends BaseWheelAdapter<Province.DataEntity> {
	public ProvinceWheelAdapter(Context context, List<Province.DataEntity> list) {
		super(context,list);
	}
