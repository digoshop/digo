...
/**
 * Created by Xran on 16/7/29.
 */
public class ListChoseAdapter extends BaseAdapter{
    private Context context;
    private List<ListChoseHelp> list;
    public ListChoseAdapter(Context context, List<ListChoseHelp> list) {
